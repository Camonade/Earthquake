...
import { OrbitControls } from 'three/addons/controls/OrbitControls.js';
        ...
        const ALL_VIEWS = ['home-view', 'earthquake-view', 'calendar-view', 'stress-view', 'plate-tectonics-view', 'richter-view', 'moment-view', 'surface-view', 'compare-view', 'intensity-view'];
        const KNOWLEDGE_VIEWS = ['stress-view', 'plate-tectonics-view', 'richter-view', 'moment-view', 'surface-view', 'compare-view', 'intensity-view'];
